...
from app.routers import admin_router,user_auth_router,supervisor_router, doctor_router, user_router,role_router,email_router,verification_router, integrity_router
