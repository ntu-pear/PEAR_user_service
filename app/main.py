...
origins = [
    origin for origin in [
        ...
        "http://localhost:3000",
        "http://localhost:5173",
        f"http://{os.getenv('WEB_FE_ORIGIN')}" if os.getenv('WEB_FE_ORIGIN') else None,
        f"http://{os.getenv('WEB_FE_ORIGIN_STAGING')}" if os.getenv('WEB_FE_ORIGIN_STAGING') else None,
    ]
