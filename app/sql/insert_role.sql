...
("ADmin123",1,"ADMIN", 3, GETDATE(), GETDATE(),1,1),
("DOctor12",1,"DOCTOR", 3, GETDATE(), GETDATE(),1,1),
("Guard123",1,"GUARDIAN", 3, GETDATE(), GETDATE(),1,1),
("Game1234",1,"GAME THERAPIST", 1, GETDATE(), GETDATE(),1,1),
("Super085",1,"SUPERVISOR", 3, GETDATE(), GETDATE(),1,1),
("Care1562",1,"CAREGIVER", 2, GETDATE(), GETDATE(),1,1);
